...
func TestCycles(t *testing.T) {
	...
	t.Run("a two cycle is reported once and not twice", func(t *testing.T) {
		g := a.gated(t)
	...
	t.Run("a four cycle is reported once rather than four times", func(t *testing.T) {
		g := a.gated(t)
	...
	t.Run("a cycle that does not pass through the seed is found", func(t *testing.T) {
		g := a.gated(t)
	...
	t.Run("ordering types are checked for cycles too", func(t *testing.T) {
		g := a.game(t)
	...
	t.Run("an acyclic only type with no gating is still checked", func(t *testing.T) {
		g := a.game(t)
	...
	t.Run("a symmetric type produces no cycle findings", func(t *testing.T) {
		g := a.gated(t)
	...
	t.Run("a containment loop is reported separately from a prerequisite loop", func(t *testing.T) {
		g := a.gated(t)
	...
	t.Run("a cycle report refuses a bound above its cap rather than clamping", func(t *testing.T) {
		g := a.gated(t)
